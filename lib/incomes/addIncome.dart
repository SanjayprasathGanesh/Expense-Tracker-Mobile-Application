...
class AddIncome extends StatefulWidget {
  final String u_name;
  const AddIncome({Key? key, required this.u_name}) : super(key: key);
...
class _AddIncomeState extends State<AddIncome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Add Incomes",style: TextStyle(
          color: Colors.black,
          fontFamily: 'Poppins',
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () async{
                              ...
                              if(validateName && validateDate && validateAmt && validateType && validateTrans){
                                ...
                                incomeModel.u_name = widget.u_name;
                                ...
                                var result = await _incomeService.AddIncome(incomeModel);
                                ...
                                if(result != null){
                                  ...
                                  Toast.show(
                                    "Sorry,Income Not Added Successfully",
                                    gravity: Toast.bottom,
                                    backgroundColor: Colors.red,
                                    duration: 3,
                                    textStyle: const TextStyle(
